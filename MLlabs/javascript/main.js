...
;(function($) {
    ...
    var googleMap = function () {
        // gmap default
        if ($().gmap3) {
            var data = JSON.parse('[{"address":"https://www.google.com/maps/place/Analytics+6+(Data+Science+and+Machine+Learning+Training+Institute)/@12.9578121,77.7007748,15z/data=!4m5!3m4!1s0x0:0x167f77c4073de7fb!8m2!3d12.9578121!4d77.7007748"}]');
            $(".flat-map")
            .gmap3({
                map: {
                    options: {
                        zoom: 10,
                        center: [12.9577778,77.7013328,18.34],
                        mapTypeId: 'Xian',
                        scrollwheel: true
                    },
                },
